-- =====================================================
-- Complete Fix for All Functions and Tables (SAFE VERSION)
-- =====================================================
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Added site_location to projects';
    END IF;
    ...
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Added site_address to projects';
    END IF;
    ...
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Added start_date to projects';
    END IF;
    ...
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Added end_date to projects';
    END IF;
    ...
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Added total_budget to projects';
    END IF;
    ...
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Added received_amount to projects';
    END IF;
    ...
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Added status to projects';
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Added budget to milestones';
    END IF;
END $$;
...
-- =====================================================
DROP FUNCTION IF EXISTS calculate_daily_rate(NUMERIC, INTEGER);
...
-- =====================================================
DROP FUNCTION IF EXISTS calculate_milestone_budget(UUID);
...
BEGIN
    IF NOT EXISTS (
        ...
        CREATE INDEX idx_project_expenses_milestone_id ON project_expenses(milestone_id);
        CREATE INDEX idx_project_expenses_date ON project_expenses(expense_date);
        
        RAISE NOTICE '✓ Created project_expenses table';
    ELSE
        RAISE NOTICE '✓ project_expenses table already exists';
    END IF;
END $$;
...
BEGIN
    ...
    RAISE NOTICE '========================================';
    RAISE NOTICE 'Functions created: calculate_daily_rate, get_member_wage_config, calculate_milestone_budget';
    RAISE NOTICE 'Tables verified: project_expenses, invoices';
